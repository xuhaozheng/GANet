...
export CUDA_HOME="/usr/local/cuda-10.0"
export PATH="/usr/local/bin:/usr/local/cuda-10.0/bin:$PATH"
export CPATH="/usr/local/cuda-10.0/include"
export CUDNN_INCLUDE_DIR="/usr/local/cuda-10.0/include"
export CUDNN_LIB_DIR="/usr/local/cuda-10.0/lib64"
...
# export PATH="/usr/local/bin:/usr/local/cuda-11.1/bin:$PATH"
# export CPATH="/usr/local/cuda-11.1/include"
# export CUDNN_INCLUDE_DIR="/usr/local/cuda-11.1/include"
# export CUDNN_LIB_DIR="/usr/local/cuda-11.1/lib64"
